...
![](docs/june/web/health-medical-insurance-vector-28999951.jpg)
...
library(ggplot2)
library(DT)
insurance <- read_csv("docs/june/web/insurance.csv")
```
...
![](docs/june/web/10.58.58 PM.jpeg)
...
![](docs/june/web/hottest-real-estate-markets-2021.jpg)
